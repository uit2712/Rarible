...
function CollectibleAvatar() {
    return (
        <div className="sc-bdnylx sc-bXmIKc jbxvPE FCaZG">
            <div className="sc-bdnylx sc-iKUUYu jbxvPE hZNOjn">
                <div data-marker="root/appPage/address/changeCover/attachmentUpload/attachment" className="sc-bdnylx sc-gLMhmw huvQjR bGmCZv"></div>
                <div className="sc-bdnylx sc-gLMhmw jbxvPE hXZlkr"></div>
            </div>
            <div className="sc-bdnylx sc-ezHfOa jbxvPE vnmiW">
                <div className="sc-bdnylx sc-cTsKXF jbxvPE eGEqCh">
                    <div className="sc-carGAA sc-lbVuaH dpbdIG ifyazv">
                        <div className="sc-carGAA sc-gGLyOc dpbdIG edtvRX">
                            <div className="sc-bdnylx sc-laZMyp eIaCHA kiRdWm" style={{
                                width: 120,
                                height: 120,
                            }}>
                                <img src="https://images.rarible.com/?fit=outsize&amp;n=-1&amp;url=https%3A%2F%2Fipfs.rarible.com%2Fipfs%2FQmTby3qTjLc9VapBxYEb64Zfn6oHxQbhV6giFYoxBaZJzw&amp;w=240" className="sc-khIgXV sc-hTRkEk ljAugV hpHFSK sc-gSYCTC fkCSEE" loading="lazy" style={{
                                    visibility: 'visible',
                                    position: 'relative',
                                    opacity: 1,
                                }}/>
